...
export function Profile() {
  ...
  const getMoviesFromApi = () => {
    return fetch('https://api.themoviedb.org/3/movie/top_rated?api_key=f91a6fa5f3b47945b773d716d9579059&language=en-US')
...
const MovieComponent: React.FC<Props> = props => {
  ...
  return (
    <View>
      <Text style={{textAlign: 'center', fontSize:30, color:'#000', marginBottom:10}}>Film được đánh giá cao nhất</Text>
      <FlatList
